            ...
            if _wm_files:
                try:
                    ...
                    _wm_combined_html = (
                        ...
                        '  var origSvg=triggerEl?triggerEl.querySelector(\'svg\'):null;if(!origSvg)return;\n'
...
'function _wmPatBuildCtrl(allKeys){\n'
                        ...
                        '        var _upmEntry=WM_PAT.upmCols&&WM_PAT.upmCols[0];\n'
                        '        var _upmTgt=Array.isArray(_upmEntry)?_upmEntry[1]:null;\n'
                        '        var _upmRaw=d[4]!==undefined&&d[4]!==null?d[4]:null;\n'
                        '        if(_wmIsFail(ibKey)){\n'
                        '          fill=(_upmRaw!==null&&_upmTgt)?_wmUpmColor(_upmRaw/_upmTgt*100):"#c8c8c8";opacity="1";\n'
                        '        } else if(_upmRaw!==null&&_upmTgt){\n'
                        '          fill=_wmUpmColor(_upmRaw/_upmTgt*100);opacity="1";\n'
                        '        } else {\n'
                        ...
                        '        var _isEdge=(_wmEdgeExcRows>0&&(x<xMin+_wmEdgeExcRows||x>xMax-_wmEdgeExcRows||y<yMin+_wmEdgeExcRows||y>yMax-_wmEdgeExcRows));if(_isEdge){opacity="0.15";}else{failXn.push(xn);failYn.push(yn);failActX.push(x);failActY.push(y);failDies++;\n'
                        ...
                        '      var _tagFs2=Math.max(4,Math.min(7,Math.round(cs*0.55)));\n'
                        '      if(_dieTag2&&cs>=4){rects.push(\'<text x="\'+( parseFloat(px)+cs-0.5).toFixed(1)+\'" y="\'+( parseFloat(py)+_tagFs2+0.5).toFixed(1)+\'" text-anchor="end" font-size="\'+_tagFs2+\'" fill="#000" font-weight="bold" opacity="\'+opacity+\'" data-ib="\'+ibKey+\'" data-op="\'+opacity+\'" pointer-events="none">\'+_dieTag2+\'</text>\');}\n'
                        '    });\n'
                        ...
                        '      });\n'
                        '    }\n'
                        '    var svgStr=\'<svg width="\'+W+\'" height="\'+H+\'" style="display:block;margin:0 auto;cursor:crosshair" onmousemove="_wmDieHover(event,this)" onmouseleave="_wmDieHoverOut()">\'\n'
                        ...
                        '    mapsHtml+=\'<div style="text-align:center;padding:4px 2px">\'\n'
