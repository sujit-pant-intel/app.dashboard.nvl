            ...
            if _wm_files:
                try:
                    ...
                    _wm_combined_html = (
                        ...
                        +'        <button onclick="_wmPatSetZoom(-0.25)" style="background:rgba(255,255,255,.15);border:1px solid rgba(255,255,255,.4);color:#fff;font-size:13px;cursor:pointer;padding:0 7px;border-radius:4px;margin-left:6px;line-height:1.6" title="Zoom out">&#8722;</button>\n'
                        ...
                        +'        <button onclick="_wmPatSetZoom(+0.25)" style="background:rgba(255,255,255,.15);border:1px solid rgba(255,255,255,.4);color:#fff;font-size:13px;cursor:pointer;padding:0 7px;border-radius:4px;line-height:1.6" title="Zoom in">&#43;</button>\n'
                        +'      </div>\n'
...
'}\n'
                        ...
                        'function _wmPatSetZoom(delta){_wmPatZoom=Math.min(4,Math.max(0.25,Math.round((_wmPatZoom+delta)*100)/100));var z=document.getElementById("wm-zoom-pct");if(z)z.textContent=Math.round(_wmPatZoom*100)+"%";_wmPatRender();}\n'
