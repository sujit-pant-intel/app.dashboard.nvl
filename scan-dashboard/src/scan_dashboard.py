"""scan_dashboard.py -- HRY Scan Analysis: combined GUI tab + headless pipeline.

Merges the former hry_frame.py (Tkinter GUI tab) and pipeline.py (RAWSTR
processing + dashboard build) into a single module.

Usage (CLI / headless pipeline):
  python scan_dashboard.py --input data.csv --config hry_config.csv --output ./results

Usage (GUI, from dashboard.py):
...
def write_dashboard(result: dict, output_dir: Path, standalone: bool = False):
    ...
    js_content = "// Auto-generated by scan_dashboard.py -- do not edit manually\n"
...
# ===========================================================================
# GUI: HRYFrame  (Tkinter tab embedded by dashboard.py)
# ===========================================================================
